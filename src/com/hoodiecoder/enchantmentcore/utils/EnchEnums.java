...
public class EnchEnums {
	...
	/**
	 * Enum representing a type of listener supported by the custom enchantments.
	 */
	...
	public enum MaterialType {
		...
		/** Represents all netherite tools. */ NETHERITE(), /** Represents all netherite armor. */ NETHERITE_ARMOR(),
		/** Represents all other materials. */ OTHER();
		...
		MaterialType() {
			if (this.toString().equals("NETHERITE_ARMOR") && EnchantmentUtils.getGenerator().getMinecraftVersion() >= 16) {
				this.materials = Arrays.asList(new Material[] {NETHERITE_HELMET, NETHERITE_CHESTPLATE, NETHERITE_LEGGINGS, NETHERITE_BOOTS});
				...
				this.materials = Arrays.asList(new Material[] {NETHERITE_SWORD, NETHERITE_PICKAXE, NETHERITE_AXE, NETHERITE_SHOVEL, NETHERITE_HOE});
				this.repairs = Arrays.asList(NETHERITE_INGOT);
			} else {

...
public class NameableCraftEnchantment_v1_16_R3 extends CraftEnchantment implements NameableCraftEnchantment {
	private final Enchantment target;
	private final String id;
	
	public NameableCraftEnchantment_v1_16_R3(Enchantment target, String name) {
		super(target);
		this.target = target;

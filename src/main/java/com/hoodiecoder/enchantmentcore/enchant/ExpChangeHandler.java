...
/**
 * An extension to {@link com.hoodiecoder.enchantmentcore.CustomEnch} to deal with exp change event
 */
public interface ExpChangeHandler {
     ...
     */
    void onGainExp(Player player, List<Integer> levels, List<ItemStack> items, PlayerExpChangeEvent event);
}
